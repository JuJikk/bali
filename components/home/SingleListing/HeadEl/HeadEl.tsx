...
import {getPrice, formatPrices} from "@/utils/calculations";
...
function HeadEl({ propertyDetails }: HeadElProps) {
  ...
  const handleLike = () => {
    toggleLike(propertyDetails.properties[0].listingId);
    const newCount = likedCards[propertyDetails.properties[0].listingId]
        ? likeCount - 1
        : likeCount + 1;
    const message = likedCards[propertyDetails.properties[0].listingId]
        ? "Listing removed!"
        : "Listing saved!";
  ...
  return (
      <Container>
        <div className="hidden lg:flex justify-between items-center pt-6">
          <div className="">
            <h1 className="text-3xl font-bold text-grays-1000">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
                type="button"
                aria-label={
                  likedCards[propertyDetails.properties[0].listingId]
                      ? "Saved"
                      : "Unsaved"
                }
            ...
            >
              <LikeButton
                  classType={
                    likedCards[propertyDetails.properties[0].listingId] ? "active" : ""
                  }
              />
            </button>
          </div>
        ...
        <div className="lg:flex-row lg:items-center lg:gap-0 hidden lg:flex flex-col gap-2 justify-between items-start pt-4 pb-8 ">
          <div className="flex items-center">
            ...
            <div className="pl-[10px]">
              ...
              <span className="text-grays-1000"> {propertyDetails.firstContent?.owner?.name}</span>
            </div>
          </div>
          ...
          <span className="text-h3 leading-h3 text-grays-500">
            ...
            <span className="text-h3 leading-h3 text-black pl-6 font-semibold text-grays-1000">
